...
export default function RouterView({ currentPage, onNavigate }) {
  const pageVariants = {
...
function Decor() {
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 -z-10">
      <div className="absolute inset-0 bg-[radial-gradient(1200px_600px_at_80%_0%,rgba(212,175,55,0.12),transparent_60%)]" />
    ...
    <div className="relative min-h-[calc(100vh-4rem)] flex items-stretch">
      <div className="absolute inset-0 overflow-hidden">
        <video
          ...
          src="https://cdn.coverr.co/videos/coverr-luxury-oceanfront-villas-2683/1080p.mp4"
          autoPlay
          muted
          loop
          playsInline
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 flex flex-col items-start justify-center py-24 gap-6">
        <motion.h1
          initial={{ opacity: 0, y: 20 }}
        ...
        >
          ...
          <span className="block text-transparent bg-clip-text bg-gradient-to-r from-[#D4AF37] to-yellow-300">Crafted for the Few</span>
        </motion.h1>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          Aurora Estates curates a portfolio of distinguished residences in the world's most coveted locations.
          Experience tailored service and architectural excellence in every detail.
        </motion.p>
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.9, delay: 0.2 }}>
          <button onClick={onCTA} className="group inline-flex items-center gap-3 bg-gradient-to-r from-[#D4AF37] to-yellow-500 text-[#0b1b2b] font-medium px-6 py-3 rounded-full shadow-lg shadow-yellow-900/30">
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-6 py-16">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {listings.map((item) => (
          <article key={item.id} className="group relative rounded-2xl overflow-hidden bg-white/5 border border-white/10">
            <div className="aspect-[4/3] overflow-hidden">
              <img src={item.image} alt={item.title} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
            </div>
            <div className="absolute inset-0 bg-gradient-to-t from-[#0b1b2b] via-transparent to-transparent opacity-70" />
            ...
            <div className="p-4 border-t border-white/10 flex items-center justify-between bg-white/5">
              <button onClick={() => setActive(item)} className="text-sm px-4 py-2 rounded-full bg-white/10 hover:bg-white/15">
                Quick View
              </button>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="space-y-3">
                ...
                <div className="pt-4 flex flex-wrap gap-3">
                  <button className="px-5 py-2 rounded-full bg-gradient-to-r from-[#D4AF37] to-yellow-500 text-[#0b1b2b] font-medium">Schedule Tour</button>
    ...
    <div className="max-w-7xl mx-auto px-4 md:px-6 py-16">
      <div className="mb-10 max-w-3xl">
        ...
        <p className="text-white/75 mt-3">
          Since our inception, Aurora Estates has championed a bespoke approach to real estate—discreet, data-informed, and design-led.
    ...
    <div className="max-w-7xl mx-auto px-4 md:px-6 py-16 grid lg:grid-cols-2 gap-10">
      <div>
        ...
        <div className="mt-6 space-y-3 text-white/80">
          ...
          <div className="flex items-center gap-3"><Mail size={18} className="text-[#D4AF37]" /> concierge@auroraestates.com</div>
      ...
      <div>
        <form className="rounded-2xl p-6 bg-white/5 border border-white/10 backdrop-blur">
          ...
          <div className="mt-6">
            <button type="submit" className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-[#D4AF37] to-yellow-500 text-[#0b1b2b] font-medium">
              Send Message
              <ArrowRight size={18} />
            </button>
          </div>
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        exit={{ y: 20, opacity: 0 }}
        className="relative z-10 w-full max-w-4xl rounded-2xl p-6 bg-[#0b1b2b] border border-white/10 shadow-2xl"
      >
